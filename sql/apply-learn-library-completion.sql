-- Twin of supabase/migrations/0050_learn_library_completion.sql
-- Manual apply helper for SQL Editor / Coolify ops.
--
-- PRODUCTION: If you already pasted the Learn Library completion SQL successfully,
-- do NOT run this again. First run sql/verify-learn-library-completion.sql.
-- All statements are idempotent when a re-apply is genuinely required.

-- Additive Free Learning Library completion: artwork status + certificate pricing metadata + server progress.
