...
const optional = [
  ...
  { key: "EMAIL_FROM_NAME", label: "Email sender name", fallback: "DigitalSkillX" },
  { key: "EMAIL_FROM_ADDRESS", label: "Email sender address", fallback: "courses@digitalskillx.com" },
