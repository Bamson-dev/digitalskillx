-- Sales Conversion Engine (Phase 3) — additive only
-- Extends product_events indexing; adds leads + admin course recommendations.

-- Funnel query indexes (avoid full scans on large event tables)
...
-- Lead capture (dedupe by course + email)
...
-- Admin-controlled cross-sell / upsell / downsell / related recommendations
