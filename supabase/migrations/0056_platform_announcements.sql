-- Fixed / scheduled student announcements (dashboard banners).
-- Separate from one-shot notification emails in public.notifications.
...
-- Students (any authenticated user) can read currently visible announcements.
